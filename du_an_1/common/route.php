...
//Danh sách
$router->get('admin/chi-tiet-don-hang/{id}',[\App\Controllers\Admin\ChiTietDonHangController::class,'danhSach']);

//Bình luận
$router->post('binh-luan-post' , [GioHangController::class , 'binhLuanPost']);
