...
class baseModel
{
    ...
    //Function count the record on the table, kết quả trả về sẽ là một cột
    ...
    // ID cuối cùng được truyền vào database
    ...
    //load all
    //Trả về limit 2 bản ghi từ limit1 bản ghi
    ...
    //load one
    //Trả về 1 hàng có giá trị cần lấy
    ...
    //find
    // Tìm kiếm $find_variable từ bảng $table có $variable = '$input_variable'
