...
{{--                                        </li>--}}
                            ...
                            <div class="col-lg-6 mb--40">
                                ...
                                <div class="comment-respond pro-des-commend-respond mt--0">
                                    ...
                                    <form action="{{url('binh-luan-post')}}" method="post">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <input type="hidden" name="san_pham_id" value="{{$load_one->id_sp}}">
                                                    <label>Other Notes (optional)</label>
                                                    <textarea name="binh_luan" placeholder="Your Comment"></textarea>
                                                </div>
                                            </div>

                                            <div class="col-lg-12">
                                                <div class="form-submit">
                                                    <button type="submit" name="binhLuan"
