...
@section('content')
    <div class="projcard-container">
        ...
        <div class="projcard projcard-blue">
            <div class="projcard-innerbox">
                <img class="projcard-img" src="https://images.fpt.shop/unsafe/filters:quality(90)/fptshop.com.vn/uploads/images/tin-tuc/156736/Originals/Gia%CC%81%20so%CC%82%CC%81c%20cuo%CC%82%CC%81i%20tua%CC%82%CC%80n.png" />
                <div class="projcard-textbox">
                    <div class="projcard-title">Siêu Giảm Giá</div>
                    <div class="projcard-subtitle">Tin Tức công nghệ</div>
                    <div class="projcard-bar"></div>
                    <div class="projcard-description">Cùng FPT Shop săn ngay siêu ưu đãi đến 50% cho các sản phẩm công nghệ và gia dụng</div>
                    <div class="projcard-tagbox">
                        <span class="projcard-tag">FPT</span>
                        <span class="projcard-tag">Shop</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="projcard projcard-red">
            <div class="projcard-innerbox">
                <img class="projcard-img" src="https://images.fpt.shop/unsafe/filters:quality(90)/fptshop.com.vn/uploads/images/tin-tuc/156730/Originals/RC_Collection_1000x1000%20(10).png" />
                <div class="projcard-textbox">
                    <div class="projcard-title">FPT Shop đồng loạt mở bán Xiaomi Redmi Note 12 Series cùng ưu đãi đến 750.000 đồng</div>
                    <div class="projcard-subtitle">Tin khuyến </div>
                    <div class="projcard-bar"></div>
                    <div class="projcard-description">Từ ngày 07/04/2023 đến 30/04/2023, khi chọn mua Xiaomi Redmi Note 12 Series tại FPT Shop, khách hàng sẽ được nhận ngay ưu đãi đến 750.000 đồng</div>
                    <div class="projcard-tagbox">
                        <span class="projcard-tag">FPT.SHOP</span>
                        <span class="projcard-tag">FPT</span>
        ...
        <div class="projcard projcard-green">
            <div class="projcard-innerbox">
                <img class="projcard-img" src="https://images.fpt.shop/unsafe/filters:quality(90)/fptshop.com.vn/uploads/images/tin-tuc/156507/Originals/061A2590.jpg" />
                <div class="projcard-textbox">
                    <div class="projcard-title">Chỉ còn 1 ngày đặt trước OPPO Find N2 Flip, đặt ngay để nhận quà tặng hấp dẫn!</div>
                    <div class="projcard-subtitle">Tin tức khuyến mãi</div>
                    <div class="projcard-bar"></div>
                    <div class="projcard-description">Smartphone gập siêu hot OPPO Find N2 Flip chỉ còn một ngày đặt trước để nhận quà hấp dẫn. Nếu bạn yêu thích Find N2 Flip thì đừng bỏ lỡ cơ hội này nhé!</div>
                    <div class="projcard-tagbox">
                        <span class="projcard-tag">OPPO</span>
                        <span class="projcard-tag">SHOP</span>
                    </div>
                </div>
            </div>
    ...
    </div><div class="projcard-container">
    ...
    <script>// This adds some nice ellipsis to the description:
