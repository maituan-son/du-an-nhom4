...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="d-flex align-items-center ms-4 mb-4">
            ...
            <div class="ms-3">
                <h6 class="mb-0">Trang quản trị</h6>
                <span>Admin</span>
            </div>
        </div>
        <div class="navbar-nav w-100">
            ...
            <a href="{{url('admin/hoa-don')}}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Bình luận</a>
            <!-- <a href="{{url('admin/chi-tiet-hoa-don')}}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Chi tiết hóa đơn</a> -->
